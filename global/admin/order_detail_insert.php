...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="order_detail_process.php?update" method="post">
        <?php 
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status">
                      ...
                      <option value="Confirmed" <?php echo ($lst['status']=='Confirmed')? 'selected':''; ?>>Confirmed</option>
                      <option value="Not-Confirmed" <?php echo ($lst['status']=='Not-Confirmed')? 'selected':''; ?>>Not-Confirmed</option>
                    </select>
                  </div>  
                </div>
